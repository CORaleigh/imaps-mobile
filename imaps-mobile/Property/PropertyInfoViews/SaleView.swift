    ...
    var body: some View {
        Group {
            ...
            Grid() {
                ...
                GridRow {
                    Text("Sale Price")
                    Text( "$"+((attributes?["TOTSALPRICE"] as? Double ?? 0)
